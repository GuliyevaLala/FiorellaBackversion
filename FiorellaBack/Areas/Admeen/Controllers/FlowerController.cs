    ...
    public class FlowerController : Controller
    {
        ...
        public IActionResult Create(Flower flower)
        {
            ...
            if (flower.MainImageFile != null)
            {
                ...
                {
                    Image = flower.MainImageFile.SaveImage(_env.WebRootPath, "Assets/photos"),
                    IsMain = true,
                    Flower = flower
                };
            ...
            foreach (var image in flower.ImageFiles)
            {
                ...
                {
                    Image = image.SaveImage(_env.WebRootPath, "Assets/phptos"),
                    IsMain = false,
                    Flower = flower
                };
        ...
        public IActionResult Edit(Flower flower)
        {
            ...
            if (flower.ImageFiles != null)
            {
                ...
                {
                    Helpers.Helper.DeleteImg(_env.WebRootPath, "Assets/photos", item.Image);
                }
                ...
                foreach (var image in flower.ImageFiles)
                {
                    FlowerImage flowerImage = new FlowerImage
                    {
                        Image = image.SaveImage(_env.WebRootPath, "Assets/photos"),
                        IsMain = false,
        ...
        public IActionResult Delete(int id)
        {
            ...
            FiorellaBack.Helpers.Helper.DeleteImg(_env.WebRootPath, "Assets/photos", existFlower.MainImageFile.ToString());
            FiorellaBack.Helpers.Helper.DeleteImg(_env.WebRootPath, "Assets/photos", existFlower.ImageFiles.ToString());
